...
# print "How much is dinner: $"
# cost = gets.chomp.to_f


# #works with numbers that don't end with a 0
# puts "Your tip is $#{(cost * 0.18).round(2)}, your total is $#{(cost * 1.18).round(2)}."

# #works with all numbers
# puts "Your tip is $#{ "%.2f" % (cost * 0.18)}, your total is $#{"%.2f" % (cost * 1.18)}."
...
puts "#{c} Uranus is #{ura_age}."
puts "#{c} Neptune is #{nep_age}."
puts "#{c} Pluto is #{plu_age}."
puts "#{c} Mercury is #{mer_age}."
puts "#{c} Venus is #{ven_age}."
